...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en"
    ...
    <head>
         ...
         *
         * File: lahof3817sortDesc.php
         ********************************************************************
         * File Description:
         *   This script sorts the song list in descending order.
         *      
    ...
    <body>
        ...
        <h2>Sort Songs in Descending Order</h2>
        ...
        if (!empty($allSongs)) {
            ...
            //sort the allSongs array in descending order
            rsort($allSongs);

            //call the displaySongs function in the inc_functions.php file
            //to display the songs sorted in descending order.
            displaySongs($allSongs, "Songs in descending order.");
